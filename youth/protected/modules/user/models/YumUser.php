...
class YumUser extends YumActiveRecord
{
  ...
  public function rules() {
    ...
    $rules[] = array('notifyType, avatar, type_id', 'safe');
    $rules[] = array('password', 'required', 'on' => array('insert', 'registration'));
    $rules[] = array('createtime, lastvisit, lastaction, superuser, status, type_id', 'numerical', 'integerOnly' => true);
